...
\title{\LARGE \bf
Inverse Dynamics Based Control of Nonlinear Teleoperators
}


\author{Ruturaj Sambhus (204100024)
	%and Bernard D. Researcher$^{2}$% <-this % stops a space
...
\item Use a zero before decimal points: 0.25, not .25. Use cm3, not ÒccÓ. (bullet list)
