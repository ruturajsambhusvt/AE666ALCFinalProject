...
thetadmdot = -taudm*(transpose(Ydm(q1m,q2m,q1mdot,q2mdot,qrmdot(1,1),qrmdot(2,1),qrmddot(1,1),qrmddot(2,1)))*sm + 0.00*[thetadcap1m;thetadcap2m;thetadcap3m]);
thetadsdot = -tauds*(transpose(Ydm(q1s,q2s,q1sdot,q2sdot,qrsdot(1,1),qrsdot(2,1),qrsddot(1,1),qrsddot(2,1)))*ss + 0.00*[thetadcap1s;thetadcap2s;thetadcap3s]);
...
thetakmdot = -taukm*(kpm*transpose(Ykm(q1m,q2m,q1mdot,q2mdot))*deltaXm + kdm*transpose(Ykm(q1m,q2m,q1mdot,q2mdot))*emdot + 0.00*[thetakcap1m;thetakcap2m]);
thetaksdot = -tauks*(kps*transpose(Ykm(q1s,q2s,q1sdot,q2sdot))*deltaXs + kds*transpose(Ykm(q1s,q2s,q1sdot,q2sdot))*esdot + 0.00*[thetakcap1s;thetakcap2s]);
